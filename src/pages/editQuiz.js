...
const handleSubmit = async (event) => {
  ...
  try {
    const docRef = await addDoc(collection(db, "quizzes"), {
      ...
      //date: new Date().toLocaleDateString(),  // Store the creation date
      createdAt: new Date().toLocaleDateString()  // Store the creation date
    });
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input placeholder="Quiz name" onChange={(e) => setName(e.target.value)}></input>
